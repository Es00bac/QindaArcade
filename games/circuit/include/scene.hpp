...
#include <string>
namespace sw {
// QMS2 assets carry authored per-face materials; legacy primitives use instances.
struct Vertex { V3 p,n; V2 uv; V4 tint{1,1,1,0}; V3 finish{.5f,0,0}; };
...
enum Primitive {Sphere,Box,Torus,Cylinder,Hull,Wing,Rock0,Rock1,Rock2,Rock3,Rock4,Rock5,Monolith,Manta,Sideplate,Ribbon,RoadSurface,RoadShell,Ear,Terrain,CrtBody,CrtGlass,ServerBody,ServerFace,CableCoil,SalvageGantry,Fern,WindPump,
 Kart0,Kart1,Kart2,Kart3,Kart4,Kart5,Kart6,Kart7,
 SalvageBin,CableReel,AppliancePile,Compactor,Conveyor,ScrapCar,Pallet,SolarArray,Greenhouse,WaterTank,PumpSkid,Planter,VentBank,TransitShelter,FreightCrate,SignalMast,SnowFence,WeatherStation,RescueSled,AlpinePine,Count};
struct Frame {
 arcade::Ui ui;
 ...
 float driftCharge=0;double raceTime=0;
 std::string itemLabel;bool itemReady=false;
...
inline constexpr float driverScale(int id){return id==1?.62f:id==4?.65f:id==7?.63f:.82f;}
