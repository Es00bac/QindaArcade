...
public:
 ...
 void configurePlayers(int count,const std::array<int,4>& characters);
 void control(int slot,const arcade::Control& c){if(slot>=0&&slot<8)controls_[slot].merge(c);}
